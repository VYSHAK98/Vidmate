    ...
    <div id='f' className='p-2'>
      <Row>
        ...
        <Col className='container '>
          ...
          <h className='text-light'><span className='p-2'><i class="fa-solid fa-link fa-beat fa-lg"></i></span>Links</h>
          <div className='p-2'>
        ...
        <Col>
          <h3 className='d text-white fs-5'>Connect With Us</h3>
